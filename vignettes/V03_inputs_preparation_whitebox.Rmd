...
The `whitebox` package provides all the tools to perform a usual catchment delineation workflow from a DEM and outlets coordinates. It can be done in 6 different steps:
